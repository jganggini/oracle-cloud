  ...
  |---------------------------|------------------------------------------------------------|----------------------|
  | STAGING    | OBI_STAGING  | oracleidentitycloudservice/correo@dominio.com.com        | a:sdMVACop{7oVd]JZM5 |
  |---------------------------|------------------------------------------------------------|----------------------|
  | WORKFLOW   | OBI_WORKFLOW | oracleidentitycloudservice/correo@dominio.com.com        | a:sdMVACop{7oVd]JZM5 |
  |------------|--------------|------------------------------------------------------------|----------------------|
  | MAPPING    | OBI_MAPPING  | oracleidentitycloudservice/correo@dominio.com.com        | a:sdMVACop{7oVd]JZM5 |
  |------------|--------------|------------------------------------------------------------|----------------------|
  | UTILITY    | OBI_UTILITY  | oracleidentitycloudservice/correo@dominio.com.com        | a:sdMVACop{7oVd]JZM5 |
  |------------|--------------|------------------------------------------------------------|----------------------|
  | DATASET    | OBI_DATA     | oracleidentitycloudservice/correo@dominio.com.com        | a:sdMVACop{7oVd]JZM5 |
  `--------------------------------------------------------------------------------------------------------------*/
