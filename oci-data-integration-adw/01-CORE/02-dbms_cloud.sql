  ...
  |------------|--------------|------------------------------------------------------------|----------------------|
  | STAGING    | STG          | oracleidentitycloudservice/correo@dominio.com.com        | .dr>3GRjr<dB6bc#x7(7 |
  |------------|--------------|------------------------------------------------------------|----------------------|
  | DATASET    | DTS          | oracleidentitycloudservice/correo@dominio.com.com        | .dr>3GRjr<dB6bc#x7(7 |
  `--------------------------------------------------------------------------------------------------------------*/
