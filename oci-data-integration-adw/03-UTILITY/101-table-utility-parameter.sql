  ...
  INSERT INTO UTL.PARAMETER (wkf_name,                           par_order,            par_name,             par_value,                                          par_detail,           audit_user)
                     VALUES ('wkf_data_join_table_for_process',  1,                    'p_table_name_1',     'stg1.persons_demo',                                'Process Name',       'correo@dominio.com.com');
  INSERT INTO UTL.PARAMETER (wkf_name,                           par_order,            par_name,             par_value,                                          par_detail,           audit_user)
                     VALUES ('wkf_data_join_table_for_process',  2,                    'p_table_name_2',     'stg2.persons_demo',                                'Process Name',       'correo@dominio.com.com');
  INSERT INTO UTL.PARAMETER (wkf_name,                           par_order,            par_name,             par_value,                                          par_detail,           audit_user)
                     VALUES ('wkf_data_join_table_for_process',  3,                    'p_table_name_3',     'stg3.persons_demo',                                'Process Name',       'correo@dominio.com.com');
  INSERT INTO UTL.PARAMETER (wkf_name,                           par_order,            par_name,             par_value,                                          par_detail,           audit_user)
                     VALUES ('wkf_data_join_table_for_process',  99,                    'p_rows',             'person_id, first_name, last_name, creation_date',  'Process Name',       'correo@dominio.com.com');
  COMMIT;
